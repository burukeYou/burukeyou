package burukeyou.admin.rpc;

import burukeyou.admin.rpc.fallback.FileServiceRPCFallbackFactory;
 ...
 *
 */
@FeignClient(name = MicroServiceName.FILE_SERVER,fallback = FileServiceRPCFallbackFactory.class)
